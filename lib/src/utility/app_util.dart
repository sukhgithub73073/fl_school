...
List<DropListModel> getReligionList(){
  return  [
    DropListModel(name: "Christianity", id: "1"),
    DropListModel(name: "Islam", id: "2"),
    DropListModel(name: "Hinduism", id: "3"),
    DropListModel(name: "Buddhism", id: "4"),
    DropListModel(name: "Judaism", id: "5"),
    DropListModel(name: "Sikhism", id: "6"),
    DropListModel(name: "Atheism", id: "7"),
    DropListModel(name: "Other", id: "8"),
  ];
}
List<DropListModel> getQualificationList(){
  ...
  list.add(DropListModel(name: "Information Technology Certification", id: "20"));
  ...
  list.add(DropListModel(name: "Foreign Language Proficiency Certification", id: "34"));
  ...
  list.add(DropListModel(name: "Supply Chain Management Certification", id: "38"));
